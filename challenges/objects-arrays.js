...
console.log(tyran.weight); `7000kg`

// What was the diet of a velociraptor?
console.log(velo.diet); `carnivorous`

// How long was a stegosaurus?
console.log(stego.length); `9m`

// What time period did tyrannosaurus live in?
console.log(tyran.period);`Late Cretaceous`
...
const unisWithUni = graduates.map(function(item){
  if(item.university.includes('Uni') !== undefined){

    return item.university;
  }});
console.log(unisWithUni.map(unisWithUni => ({unisWithUni})));
...
*/
const popArr = zooAnimals.map(function(item){
  return item.population;
});

const populationTotal = popArr.reduce(function(accumulator, currentValue){
